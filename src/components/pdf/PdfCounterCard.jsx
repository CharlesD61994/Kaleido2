  ...
  if (compact) {
    ...
    return (
      <div
        ...
        style={{ background: "transparent", borderRadius: 0, border: "none", padding: "18px 0 7px", display: "flex", alignItems: "center", gap: 10, position: "relative", overflow: "hidden", width: "100%" }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, minWidth: 0, transform: swiped ? "translateX(-84px)" : "translateX(0)", transition: "transform 260ms cubic-bezier(0.22, 1, 0.36, 1)" }}>
          <div style={{ position: "relative", flexShrink: 0, width: clientButton ? circleSize + 43 : circleSize }}>
            ...
            {clientButton ? (
              <div style={{ position: "absolute", left: circleSize + 6, top: 63, display: "flex", alignItems: "center", justifyContent: "center", zIndex: 4 }}>
                {clientButton}
              </div>
            ) : null}
          </div>
          ...
          <div style={{ flex: 1, minWidth: 0, maxWidth: "none", position: "relative" }}>
            ...
            <div style={{ transform: "translateY(9px)" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
                <button onClick={decrementRang} style={{ width: 34, height: 34, borderRadius: "50%", background: `${color.bg}24`, border: `1.5px solid ${color.bg}55`, color: color.bg, fontSize: 20, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>-</button>
