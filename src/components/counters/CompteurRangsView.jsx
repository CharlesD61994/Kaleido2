    ...
    <div style={{ background: "var(--k-bg)", color: "var(--k-text)", height: "100vh", fontFamily: "'DM Sans', sans-serif", maxWidth: 430, margin: "0 auto", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, padding: "0 8px 12px", flexShrink: 0 }}>
        <div style={{ background: "linear-gradient(180deg, var(--k-surface), var(--k-surface-2))", backdropFilter: "blur(20px)", border: `2px solid ${currentPartieColor.bg}5C`, borderRadius: 20, padding: "16px 20px", textAlign: "center", boxShadow: `0 8px 32px ${currentPartieColor.bg}26` }}>
          ...
          <div style={{ color: "var(--k-text)", fontSize: 19, fontFamily: "'DM Sans', sans-serif", lineHeight: 1.34, padding: "3px 8px 4px", marginBottom: 10, textAlign: "center", whiteSpace: "normal", overflowWrap: "normal", wordBreak: "normal", maxHeight: 210, overflowY: "auto", WebkitOverflowScrolling: "touch" }}>
