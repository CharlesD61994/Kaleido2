...
<div style={{ position: "absolute", top: -12, left: 0, maxWidth: "calc(100% - 108px)", display: "inline-flex", height: 18, alignItems: "center", transform: "translateY(0)", zIndex: 5, pointerEvents: "none" }}>
