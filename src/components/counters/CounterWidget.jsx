...
const circleSize = compact ? 104 : 95;
const circleCenter = circleSize / 2;
const circleRadius = compact ? 44 : circ_r;
const circleCirc = 2 * Math.PI * circleRadius;
const labelSize = compact ? 14 : 13;
const countSize = compact ? 36 : 26;
const barHeight = compact ? 10 : 8;
...
<div style={{ color: currentPartieColor.bg, fontSize: compact ? 12 : 12, fontFamily: "monospace", marginTop: compact ? 1 : 3, fontWeight: 800 }}>/ {totalRangs}</div>
</div>
</div>
...
<div style={{ color: currentPartieColor.bg, fontSize: compact ? 17 : 15, fontWeight: 800, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{currentPartie?.nom}</div>
<div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", flexShrink: 0 }}>
<div style={{ color: currentPartieColor.bg, fontSize: compact ? 15 : 13, fontFamily: "monospace", fontWeight: 800 }}>{localRangNumber}/{currentPartieTotal}</div>
</div>
</div>
