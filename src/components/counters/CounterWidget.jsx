...
{repeatBadge ? (
<button type="button" onClick={repeatBadge.onClick} style={{ position: "absolute", left: 0, top: showInlineControls ? 63 : 72, minWidth: 58, height: 32, borderRadius: 999, border: `1px solid ${currentPartieColor.bg}44`, background: `${currentPartieColor.bg}18`, color: currentPartieColor.bg, fontSize: 13, fontWeight: 900, fontFamily: "'DM Sans', sans-serif", cursor: repeatBadge.onClick ? "pointer" : "default", zIndex: 5 }}>
{repeatBadge.label}
</button>
) : null}
