          ...
          <span key={`${part.body}-${index}`}>
            ...
            <button
              ...
              style={{
                ...
                padding: "0 2px",
                margin: 0,
                background: selected ? `linear-gradient(135deg, ${color.bg}66, ${color.light}44)` : "transparent",
                color: "#F1F0EE",
                font: "inherit",
                lineHeight: "inherit",
                cursor: "pointer",
                boxShadow: selected ? `0 0 0 2px ${color.light}88, 0 0 18px ${color.bg}66` : "none",
                textDecoration: selected ? `underline 2px ${color.light}` : "none",
