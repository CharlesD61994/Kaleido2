  ...
  const clientButton = clientName ? (
    <button
      ...
      style={{
        position: "relative",
        zIndex: 26,
        background: unreadClientMessageCount > 0 ? "rgba(244,63,94,0.18)" : "#1E1E32",
    ...
    >
      ...
      {unreadClientMessageCount > 0 ? (
        <span style={{ position: "absolute", top: -4, right: -4, minWidth: 16, height: 16, padding: "0 4px", borderRadius: 999, background: "#F43F5E", border: "2px solid #0D0D1A", color: "#fff", fontSize: 9, fontWeight: 900, lineHeight: "12px", display: "flex", alignItems: "center", justifyContent: "center" }}>
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: mainContent ? 6 : 12, position: "relative" }}>
      ...
      {showTimer && showTimerButton ? (
        ...
        >
          <div style={{ color: "#F1F0EE", fontSize: 20, fontFamily: "monospace", fontWeight: 800, textAlign: "center", marginBottom: 10 }}>{timeText}</div>
