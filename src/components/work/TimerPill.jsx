...
export default function TimerPill({ timeText, isTimerRunning, onToggleTimer, onResetTimer, color }) {
  ...
  return (
    <div style={{ display: "inline-flex", justifyContent: "flex-end", position: "relative", zIndex: 45, height: 18, alignItems: "center", transform: "translateY(-8px)" }}>
      <button
        type="button"
      ...
      {open ? (
        <div data-kaleido-modal-card="true" style={{ position: "absolute", top: 26, right: 0, background: "var(--k-surface)", border: `1px solid ${accent}44`, borderRadius: 14, padding: 10, boxShadow: "0 18px 48px rgba(0,0,0,0.30)", width: 172 }}>
