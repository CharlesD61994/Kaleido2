    ...
    <div style={{ display: "inline-flex", justifyContent: "flex-end", position: "relative", zIndex: 45, height: 15, alignItems: "center", transform: "translateY(-7px)" }}>
      <button
        ...
        style={{
          ...
          borderRadius: 999,
          background: isTimerRunning ? `${bg}33` : "rgba(255,255,255,0.06)",
          color: "#F1F0EE",
          padding: "1px 7px",
          fontSize: 11,
      ...
      {open ? (
        <div style={{ position: "absolute", top: 22, right: 0, background: "#1A1A2E", border: `1px solid ${accent}44`, borderRadius: 14, padding: 10, boxShadow: "0 18px 48px rgba(0,0,0,0.46)", width: 172 }}>
          <div style={{ color: "#F1F0EE", fontSize: 18, fontFamily: "monospace", fontWeight: 900, textAlign: "center", marginBottom: 9 }}>{timeText}</div>
